...
playerImg.src = "./img/player/ash.png";
...
const animate = () => {
  ...
  if (keys.w.pressed) {
    background.position.y += 0.125;
  }
  if (keys.a.pressed) {
    background.position.x += 0.125;
  }
  if (keys.s.pressed) {
    background.position.y -= 0.125;
  }
...
// const respirando = setInterval(() => {
//   if (respirandoVar == 6) {
//     respirandoVar = 0;
//   }
//   spritesPlayer.coluna = parado.frente[respirandoVar];
//   respirandoVar++;
